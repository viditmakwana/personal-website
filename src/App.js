                    ...
                    <div className='text-white font-mono'>
                        ...
                        <div className='grid grid-cols-1 place-items-center'>
                            ...
                            <div className='container flex flex-row pt-4' style={{ justifyContent: "space-around" }}>
                                ...
                                <svg class="h-6 w-6 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <a href="https://www.github.com/viditmakwana" target="_blank" rel="noreferrer noopener" alt="git">
                    ...
                    <div className='container text-white text-md md:text-lg font-mono col-span-5 md:col-span-4 place-items-start'>
                        <div className='container p-6'>
                            <p className='overflow-hidden'>
                                ...
                                hackathon for underrepresented genders in the world. <br/><br/>The summer so far has been an exciting experience working as a Software Engineering Intern at&nbsp;
